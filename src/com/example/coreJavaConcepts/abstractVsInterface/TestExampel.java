package com.example.coreJavaConcepts.abstractVsInterface;
...
Inheritance vs Abstraction: A
 	Java interface can be implemented using keyword “implements” 
 ...
 */
public class TestExampel {

}

interface Shape {

	//private int num;  //Illegal modifier for the interface field Shape.num; only public, static & final are permitted
	//private static final int num2 = 2; // Illegal modifier for the interface field Shape.num2; only public, static & final are permitted
	int num3 = 2;  // by default public ,static, final 
	public static final int num4 = 2;  // by default public ,static, final 
